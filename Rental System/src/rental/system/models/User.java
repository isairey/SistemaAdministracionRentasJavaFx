...
/*
    User class that will handle user data to and fro the database
*/
public class User{
    ...
    // Public function to be called in other class to insert users' data
    ...
    public ResultSet fetch(String email, String password){
        ...
        try{
            ...
            // Creating statements to be executed
            String sql = "SELECT Email, Password FROM User WHERE "
                    + "((Email = ?) && (Password = ?))";
    ...
    // Overloaded Public method that returns a ResultSet obtained from the 
    // database
